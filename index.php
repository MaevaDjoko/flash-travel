...
<body>
    <header>
        ...
        <ul class="menu">
            <li><a href="" class="a1"><img src="img/reception.png" alt="" width="30" height="30">Accueil</a></li>
            ...
            <li><a href="#presentation" class="a1"><img src="img/bus-station.png" alt="" width="30" height="30"><span>Destinations</span></a>
                <ul class="submenu">
                    ...
                    <li>
                        <a href="#presentation">Yaounde-Bafoussam</a>
                    </li>
                    <li>
                        <a href="#presentation">Yaounde-Douala</a>
                    </li>
                    <li>
                        <a href="#presentation">Bafoussam-Douala</a>
                    </li>
                    <li>
                        <a href="#presentation">Bafoussam-Douala</a>
                    </li>
        ...
        <a href="connexionad.php" class="btn-reservation"> Profil Administrateur</a>
    ...
    <section id="home">
        ...
        <a href="connexion.php" class="btn-reservation home-btn" target="_blank">Reserver Maintenant</a>
    </section>
    ...
    <div id="about">
        ...
        <div id="bloc">
            ...
            <p id="text2">
                <img class="img" src="img/apropos.jpeg" alt="" width="410" height="350" top="0">
            </p>
        </div>
    </div>
