...
class validation {
    ...
    // (D) SAVE RESERVATION
    function save ($nom, $prenom, $tel, $numcni, $datedepart, $heuredepart, $type, $prixticket, $bagage, $date, $iddep, $depart, $arrivee) {
      ...
      try {
          ...
          $this->stmt->execute([$nom, $prenom, $tel, $numcni, $datedepart, $heuredepart, $type, $prixticket, $bagage, $date, $iddep, $depart, $arrivee]);
          return true;
      } catch (Exception $ex) {
